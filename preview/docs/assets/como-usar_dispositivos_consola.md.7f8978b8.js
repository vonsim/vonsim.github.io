...
<span class="line"></span></code></pre></div><p>Con la interrupción 7 (<code>INT 7</code>) se escribe una cadena de caracteres en la consola. Recibe dos parámetros:</p><ul><li><code>AL</code>: longitud de la cadena a imprimir</li><li><code>BX</code>: dirección de memoria donde empieza la cadena</li></ul><div class="language-asm"><button title="Copy Code" class="copy"></button><span class="lang">asm</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">ORG </span><span style="color:#F78C6C;">1000h</span></span>
